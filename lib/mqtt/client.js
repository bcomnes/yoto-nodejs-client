...
/**
 * @import { MqttClient, IDisconnectPacket } from 'mqtt'
 */
 ...
 * @property {number} dnowBrightness - Current display brightness (0-100, actual value)
...
export class YotoMqttClient extends EventEmitter {
  ...
  #setupEventHandlers () {
    ...
    this.mqttClient.on('connect', async () => {
      ...
      // Only emit connect after subscriptions are ready
      this.emit('connect')
    })
