...
Changelog and releasing are automated with pnpm scripts and actions. To create a release:
...
- Features are sometimes welcome.
  - Please open an issue to discuss the idea prior to spending time on the problem.
  - It may be rejected.
